...
'use strict';
if (typeof module!='undefined' && module.exports) var Aes = require('./aes.js'); // CommonJS (Node.js)
 ...
 * The password is directly used to generate the encryption key via AES itself. 
 * This is less secure than using a key derivation function like PBKDF2
 */
Aes.Ctr.encrypt = function(plaintext, password, nBits) {
    ...
    // IV Generation: unique for each encryption operation
