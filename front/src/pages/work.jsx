        ...
        <div className="work">
            <div className="container">
                ...
                <div className="features">
                    <h3>Three Features That Make You Choose Secur</h3>
                    <div className="cards">
                        <div className="card">
                        ...
                        <div className="card">
                            ...
                            <p>Secur adheres to international healthcare data protection regulations such as HIPAA and GDPR. This ensures not only the safety of the data but also compliance with legal and ethical standards for managing medical information.</p>
                        </div>
                    </div>
                </div>
            </div>
